...
class AppColors {
  ...
  // GoBuddy Group Expense palette.
  static const expenseDarkPrimary = Color(0xFF281958);
  static const expensePrimary = Color(0xFF7C3AED);
  static const expenseSurface = Color(0xFFF7F4FD);
